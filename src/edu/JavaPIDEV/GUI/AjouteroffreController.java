...
public class AjouteroffreController implements Initializable {
   ...
   //      this.combodated.setDayCellFactory((Callback<DatePicker, DateCell>) dated);
    ...
    @FXML
    private void addoffre(ActionEvent event) throws IOException, MessagingException {
       ...
       // String pourcentagepromo = txtpourcentage.getText();
        ...
        of.ajouteroffre(off);
            ...
            String to = "ahmed.manaa@esprit.tn";
    ...
    private Boolean testDateDeb() {
        ...
        if ( combodated.getValue()!= null && combodated.getValue().compareTo(now) >= 0 ) {
                checkdatedeb.setImage(new Image("image/checkMark.png"));
                return true;
            } else {
                checkdatedeb.setImage(new Image("image/erreurCheckMark.png"));
            }
                return false;
    }
      private Boolean testDateFin() {
        ...
        if ( combodatef.getValue()!= null && combodatef.getValue().compareTo(combodated.getValue()) > 0 ) {
                checkdatefin.setImage(new Image("image/checkMark.png"));
                return true;
            } else {
                checkdatefin.setImage(new Image("image/erreurCheckMark.png"));
            }
                return false;
    }
      ...
      if(txtpourcentage.getSelectionModel().getSelectedItem() != null ){
          checkpourcentage.setImage(new Image("image/checkMark.png"));
                return true;
            } else {
                checkpourcentage.setImage(new Image("image/erreurCheckMark.png"));
            }
                return false;
      }
