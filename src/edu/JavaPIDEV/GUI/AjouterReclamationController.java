...
//    private TextField id_rec;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cin.setText(String.valueOf(UserconnectedC.getCin()));
        email.setText(String.valueOf(UserconnectedC.getEmail()));
    ...
    private void AddRec(ActionEvent event) throws IOException {
        if (testSaisie()) {
            ...
            try {
                ...
                ModifyRECLAMATIONAlert.setTitle("Ajouter Réclamation");
                ModifyRECLAMATIONAlert.setHeaderText(null);
                ModifyRECLAMATIONAlert.setContentText("Veuillez ajouter cette Réclamation ?");
                ...
                if (optionModifyBookAlert.get() == ButtonType.OK) {
                    ...
                    succDeleteAdminAlert.setTitle("Ajouter Réclamation");
                    succDeleteAdminAlert.setHeaderText("Resultats:");
                    succDeleteAdminAlert.setContentText("Réclamation Ajouter !");
...
//            
    ...
    private void retour(ActionEvent event) {
        try {
            ...
            stage.close();
            Scene scene = new Scene(FXMLLoader.load(getClass().getResource("MenuRec.fxml")));
