...
//    }
  ...
  //  idColumn.setCellValueFactory(new PropertyValueFactory<>("id_rec"));
   ...
   void search_Rec() {
    ...
    @FXML
    private void repondreRec(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("RepondreREC.fxml"));
    ...
    @FXML
    private void changeScreenReserv(ActionEvent event) throws IOException {
